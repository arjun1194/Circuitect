...
export const LEVELS = [
    {
        ...
        check: () => state.components.some(c => c.type === TYPES.LED && c.param === 1)
    },
    {
        ...
        check: () => state.components.some(c => c.type === TYPES.LED && c.param === 1) &&
            state.components.some(c => c.type === TYPES.SWITCH)
    },
    {
        ...
        check: () => state.components.some(c => c.type === TYPES.RESISTOR) &&
            state.components.some(c => c.type === TYPES.LED && c.param === 1)
    },
    {
        ...
        check: () => state.components.filter(c => c.type === TYPES.LED && c.param === 1).length >= 2
    },
    {
        ...
        check: () => state.components.some(c => c.type === TYPES.CAPACITOR)
    },
    {
        ...
        check: () => state.components.some(c => c.type === TYPES.TRANSISTOR) &&
            state.components.some(c => c.type === TYPES.LED && c.param === 1)
    },
    {
    ...
    },
    {
        ...
        check: () => state.components.filter(c => c.type === TYPES.SWITCH).length >= 2
    },
    {
        ...
        check: () => state.components.some(c => c.type === TYPES.CHIP && c.logic === 'XOR')
    },
    {
        ...
        check: () => state.components.some(c => c.logic === 'XOR') &&
            state.components.some(c => c.logic === 'AND')
    }
];
